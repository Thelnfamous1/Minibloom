...
@OnlyIn(Dist.CLIENT)
public class MinibloomStanding<T extends MinibloomEntity> extends EntityModel<T> {
	...
	public MinibloomStanding() {
		...
		front_right_leg.setTextureOffset(16, 43).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 4.0F, 4.0F, 0.0F, true);

		front_left_leg = new ModelRenderer(this);
		front_left_leg.setRotationPoint(-3.0F, 20.0F, -3.0F);
		front_left_leg.setTextureOffset(0, 43).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 4.0F, 4.0F, 0.0F, false);

		back_right_leg = new ModelRenderer(this);
		back_right_leg.setRotationPoint(3.0F, 20.0F, 5.0F);
		back_right_leg.setTextureOffset(42, 27).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 4.0F, 4.0F, 0.0F, true);

		back_left_leg = new ModelRenderer(this);
		back_left_leg.setRotationPoint(-3.0F, 20.0F, 5.0F);
		back_left_leg.setTextureOffset(39, 19).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 4.0F, 4.0F, 0.0F, false);
	}
