...
@OnlyIn(Dist.CLIENT)
public class MinibloomSit<T extends MinibloomEntity> extends EntityModel<T> {
	...
	public MinibloomSit() {
		...
		ear_left.setTextureOffset(42, 35).addBox(-4.4772F, -1.5614F, 0.0527F, 6.0F, 4.0F, 1.0F, 0.0F, false);
		...
		body.setTextureOffset(40, 34)
				.addBox(3.0F, -6.4167F, -5.1667F, 0.0F, 6.0F, 8.0F, 0.0F, false);
		body.setTextureOffset(42, 50)
				.addBox(-1.0F, -6.4167F, -1.1667F, 8.0F, 6.0F, 0.0F, 0.0F, true);
		body.setTextureOffset(42, 50)
				.addBox(-7.0F, -6.4167F, 2.8333F, 8.0F, 6.0F, 0.0F, 0.0F, true);
		body.setTextureOffset(40, 34)
				.addBox(-3.0F, -6.4167F, -1.1667F, 0.0F, 6.0F, 8.0F, 0.0F, false);
		body.setTextureOffset(0, 0)
				.addBox(-5.0F, -0.4167F, -7.1667F, 10.0F, 7.0F, 12.0F, 0.0F, false);

		tail = new ModelRenderer(this);
		tail.setRotationPoint(-0.5F, 0.5833F, 2.8333F);
		body.addChild(tail);
		setRotationAngle(tail, 0.5672F, 0.0F, 0.0F);
		tail.setTextureOffset(25, 19).addBox(-1.0F, 3.6993F, -0.1619F, 3.0F, 0.0F, 8.0F, 0.0F, false);

		front_right_leg = new ModelRenderer(this);
		front_right_leg.setRotationPoint(3.0F, 20.0F, -3.0F);
		setRotationAngle(front_right_leg, -0.2618F, 0.0F, 0.0F);
		...
		setRotationAngle(front_left_leg, -0.2618F, 0.0F, 0.0F);
		...
		setRotationAngle(back_right_leg, 0.0F, 0.0F, -1.5708F);
		back_right_leg.setTextureOffset(42, 27)
				.addBox(-4.0F, 0.0F, -2.0F, 4.0F, 4.0F, 4.0F, 0.0F, true);

		back_left_leg = new ModelRenderer(this);
		back_left_leg.setRotationPoint(-3.0F, 28.0F, 5.0F);
		setRotationAngle(back_left_leg, 0.0F, 0.0F, 1.5708F);
